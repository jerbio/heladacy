...
namespace HeladacWeb.Migrations
{
    ...
    [Migration("20211024230140_creditCardSource")]
    partial class creditCardSource
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HeladacWeb.Models.CredentialService", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Domain_DB")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("HeladacWeb.Models.CreditCard", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("creditCardSource_DB")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("heladacUserId", "ccNumber")
                        .IsUnique()
                        .HasDatabaseName("HeladacUser_CreditCardNumber")
                        .HasFilter("[ccNumber] IS NOT NULL");
            ...
            modelBuilder.Entity("HeladacWeb.Models.HeladacUser", b =>
                {
                    ...
                    b.Property<string>("latestPhoneNumberId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("latestPhoneNumberId");
            ...
            modelBuilder.Entity("HeladacWeb.Models.PhoneNumber", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("PhoneNumberListheladacUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<bool>("isVerifiedActive")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("PhoneNumberListheladacUserId");

                    b.HasIndex("fullNumber")
                        .IsUnique()
                        .HasDatabaseName("PhoneNumber")
                        .HasFilter("[fullNumber] IS NOT NULL");

                    b.ToTable("PhoneNumbers");
                });

            modelBuilder.Entity("HeladacWeb.Models.PhoneNumberList", b =>
                {
                    b.Property<string>("heladacUserId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("heladacUserId");

                    b.ToTable("PhoneNumberList");
                });
            ...
            modelBuilder.Entity("HeladacWeb.Models.HeladacUser", b =>
                {
                    b.HasOne("HeladacWeb.Models.PhoneNumber", "latestPhoneNumber")
                        .WithMany()
                        .HasForeignKey("latestPhoneNumberId");

                    b.Navigation("latestPhoneNumber");
                });
            ...
            modelBuilder.Entity("HeladacWeb.Models.HelmUser", b =>
                {
                    ...
                    b.HasOne("HeladacWeb.Models.CreditCard", "creditCard_DB")
                        .WithMany()
                    ...
                    b.HasOne("HeladacWeb.Models.PhoneNumber", "phoneNumber")
                        .WithMany()
                        .HasForeignKey("phoneNumberId");

                    b.Navigation("credentialService_DB");

                    b.Navigation("creditCard_DB");
            ...
            modelBuilder.Entity("HeladacWeb.Models.PhoneNumber", b =>
                {
                    b.HasOne("HeladacWeb.Models.PhoneNumberList", null)
                        .WithMany("numbers")
                        .HasForeignKey("PhoneNumberListheladacUserId");
                });

            modelBuilder.Entity("HeladacWeb.Models.PhoneNumberList", b =>
                {
                    b.HasOne("HeladacWeb.Models.HeladacUser", "heladacUser")
                        .WithMany()
                        .HasForeignKey("heladacUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("heladacUser");
                });
