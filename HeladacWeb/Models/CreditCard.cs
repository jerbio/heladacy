...
namespace HeladacWeb.Models
{
    public class CreditCard
    {
        ...
        static PrivacyApi privacyApi = new PrivacyApi();
        [NotMapped]
        public virtual CreditCardSource creditCardSource { get; set; } = CreditCardSource.manual;
        ...
        public void autoPopulateCredentials(HeladacUser heladacUser)
        {
            ...
            this.creditCardSource = CreditCardSource.autoGenerated;
        }

        public void generateNewPrivacyCreditCardNumber(HeladacUser heladacUser)
        {
            privacyApi.getNewCreateCardFromPrivacy();
            this.creditCardSource = CreditCardSource.privacy;
        }
        ...
        public virtual string creditCardSource_DB
        {
            get
            {
                return creditCardSource.ToString().ToLower();
            }
            set
            {
                if (string.IsNullOrEmpty(value) || string.IsNullOrWhiteSpace(value))
                {
                    creditCardSource = CreditCardSource.manual;
                }
                else
                {
                    creditCardSource = Utility.ParseEnum<CreditCardSource>(value);
                }
            }
        }
        [Required]
